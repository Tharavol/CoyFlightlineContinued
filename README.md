...
>
> The addon folder is still named `CoyFlightline`, so this installs over the original
> as a drop-in replacement and your existing settings carry across.
